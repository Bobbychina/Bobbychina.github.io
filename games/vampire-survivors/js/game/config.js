    ...
    },
    {
      ...
      /* 玩家技能伤害（2026-09-23 站长点单：怪血有点厚，所有技能小幅加强）
         —— 加在**武器的伤害数值**上，六件武器一起吃到（statsFor 里统一施加）：
            bolt / garlic / orbit / nova / acidSpray / chain 全部 ×1.15。
         刻意只给 15%：怪的血是 ×1.5，加上这条后等效压力从 1.5 倍降到约 1.3 倍，
         既不"超标"，也让第二关的怪不至于变成磨血。
         注意：环绕骨刃 / 腐化光环上面还有 weaponMul ×1.5，两条叠起来是 ×1.725。 */
      playerDmgMul: 1.15,
